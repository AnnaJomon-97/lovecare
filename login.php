...
if ( $logout == '1' ){
    $session->unset_userdata('shop_customer_id');
    redirect('login.php');
}
$email = "";
if( isset( $_POST['btnLogin'] ) ){
    ...
    */
    ...
    if( count($form_errors) >0 ){
        ...
        $res = $db->get_row('customers',$where);
        if( $res ){
            $session->set_userdata('shop_customer_id', $res->id);
            redirect('index.php');
        }else{
            ...
            <div class="col-xl-6 col-md-10">
                ...
                <div class="login_wrap">
            		<div class="padding_eight_all bg-white">
                        ...
                        <div class="form-note text-center">Don't Have an Account? <a href="<?= base_url('register.php') ?>">Sign up now</a></div>
                    </div>
                </div>
            </div>
        </div>
